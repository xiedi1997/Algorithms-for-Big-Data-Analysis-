% use the ADMM to solve following BP problem
% min mu*||x||_1 + ||Ax-b||_2
% A1 = A' * A
...
function x1 = ADMM(A, A1, b, x0, y0, z0, t, mu, tau, eps1, eps2)
x1 = prox_method_1(A, A1, b, x0, y0, z0, t, mu, tau, eps1);
z1 = proximal_2(t * y0 + A * x1 - b, t);
y1 = y0 + (A * x1- b - z1) / t;
